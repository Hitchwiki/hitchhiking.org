# Chat timeline experience

## Purpose

Define the identity, search, navigation, interaction, retention guidance, and responsive-layout behavior of the authenticated public chat timeline.
